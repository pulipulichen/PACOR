...
let i18nGlobal = {
  ...
  "zh-TW": {
    ...
    "You still need to write {0} words more": "你還需要寫{0}字",
    "You still need to delete {0} words more": "你還需要刪除{0}字",
    "You still need to write {0} keywords more": "你還需要寫{0}個關鍵字",
    "Remaining Time: {0}": "剩餘時間：{0}",
    "ANNOTATION_TYPE.MainIdea": "關鍵字",
    "ANNOTATION_TYPE.ConfusedClarified": "疑問",
    "ANNOTATION_TYPE.Confused": "疑問",
    "ANNOTATION_TYPE.Clarified": "已釐清",
    "ANNOTATION_TYPE.SectionMainIdea": "小節關鍵字",
    "ANNOTATION_TYPE.ArticleMainIdea": "文章關鍵字",
    "{0} sec": "{0}秒",
    "{0} Annotations": "{0}篇標註",
...
let SemanticUINIWSF = () => __webpack_require__.e(/*! import() | vendors/semantic-ui-niwsf */ "vendors/semantic-ui-niwsf").then(__webpack_require__.t.bind(null, /*! ./semantic-ui-niwsf/semantic-ui-niwsf-webpack.js */ "./webpack-app/styles/semantic-ui-niwsf/semantic-ui-niwsf-webpack.js", 7))
SemanticUINIWSF()
