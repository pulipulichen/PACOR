...
let RangyManager = {
  ...
  mounted() {
    console.log('ok')
    console.log(_rangy_rangy_webpack_js__WEBPACK_IMPORTED_MODULE_0__["default"])
    //window.rangy = rangy
