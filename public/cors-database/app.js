  ...
  <div class="row">
    <div class="col-12 col-6-tablet push-3-tablet col-4-desktop push-4-desktop">
      <form class="form">
        ...
        <fieldset>
          <input class="block" type="text" name="gender" placeholder="gender">
        </fieldset>
...
const addMessage = message => {
  ...
  if(chat) {
    chat.innerHTML += `<div class="message flex flex-row">
      <img src="${user.avatar}" alt="${user.email} ${user.gender}" class="avatar">
      <div class="message-wrapper">
        <p class="message-header">
          <span class="username font-600">${user.email} (${user.gender})</span>
...
addEventListener('#send-message', 'submit', async ev => {
  ...
  await client.service('message-database').create({
    text: input.value
  });
...
client.service('message-database').on('created', addMessage);
