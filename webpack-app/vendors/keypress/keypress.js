...
(function () {
  ...
  Combo = (function () {
    function Combo(dictionary) {
      ...
      for (property in dictionary) {
        if (!__hasProp.call(dictionary, property))
          continue;
  ...
  keypress.Listener = (function () {
    function Listener(element, defaults) {
      ...
      for (property in _factory_defaults) {
        if (!__hasProp.call(_factory_defaults, property))
          continue;
    ...
    Listener.prototype.register_combo = function (combo_dictionary) {
      ...
      for (property in _ref) {
        if (!__hasProp.call(_ref, property))
          continue;
        value = _ref[property];
  ...
  KEYPRESS_DEFAULT = keypress
  
}).call(this);

module.export = KEYPRESS_DEFAULT
