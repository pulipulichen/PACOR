...
if (ref.includes("toys") == false && url.includes("toys") == false && ref.includes("mbtrx") == false && url.includes("mbtrx") == false && ref.includes("squig") == false && url.includes("squig") == false  && ref.includes("duonao") == false && url.includes("duonao") == false ) {

  var result
  var senddata = JSON.stringify(data);
  var domain = "https://fgt0swars2.execute-api.us-east-2.amazonaws.com/default/deviceAPI_production"
